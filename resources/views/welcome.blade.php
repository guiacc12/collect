        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function getItemsPerView() {
                if (window.innerWidth <= 767) {
                    return 1; // Mobile: 2 cards por vez
                } else if (window.innerWidth <= 1024) {
                    return 1; // Tablet: 3 cards por vez
                } else {
                    return 4; // Desktop: 4 cards por vez
                }
            }

            function updateCarousel() {
                const itemWidth = 100 / itemsPerView;
                innerCarousel.style.transform = `translateX(-${index * itemWidth}%)`;
                const progressPercentage = (index / (totalItems - itemsPerView)) * 100;
            ...
            nextBtn.addEventListener("click", function(e) {
                ...
                if (index < totalItems - itemsPerView) {
                    ...
                    index = 0;
                    innerCarousel.classList.add('reset-transition');
                    setTimeout(() => {
                        innerCarousel.classList.remove('reset-transition');
                    }, 10);
                }
                updateCarousel();
            });
